...
namespace SimpleGame.Shared
{
    ...
    public partial class Controller : LayoutComponentBase {
        ...
        public double ScaleMovement = 0.1;
      ...
      public void MouseMovement(double x, double y){
        ...
        private void keydownEvent(KeyboardEventArgs o){
            ...
            switch(o.Key){
                case "w" :                              
                    ...
                    MovementInput.x = -(float)System.Math.Sin(yaw)*0.1f;
                    MovementInput.z = -(float)System.Math.Cos(yaw)*0.1f;
                ...
                case "a":
                    MovementInput.x=MovementInput.x - 0.01f;
                    break;
        ...
        private void keyupEvent(KeyboardEventArgs o){
