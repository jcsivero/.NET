...
public class Actor{
   ...
   public bool Enabled {get; set;}
    ...
    public void SetTransform(Vector3 positionVector, Vector3 axisVector, double angle){
...
for(int i=0;i<_retrievedLevel.actor_list.Length;i++){
    ...
    actor.SetTransform(new Vector3(retActor.position),new Vector3(retActor.orientation.axis),retActor.orientation.angle);
